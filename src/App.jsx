      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            >
              <span>â†“</span> <span className="hidden xs:inline">Export</span> Excel
            </button>
          </div>
                        ...
                        <table className="w-full table-fixed">
                          ...
                          <tbody>
                            {person.products.map(product => (
                              <tr key={product.id} className="border-t border-gray-50 group">
                                {/* Product Name */}
                            ...
                            {addingProductFor === person.id && (
                              <tr className="border-t border-gray-50 bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-right text-gray-300">$0.00</td>
                                <td className="px-4 py-3 text-gray-300 text-sm">â€”</td>
